...
//  Serial2.println("1");
  ...
  {  
    ...
    led.DISPLAY_DIGIT1(24, 3, 0, 0) ;      //----------------------2.03 //Siddhesh
    DOT1_1=1;                              //----------------------dot on                       
  }
  else 
  {
...
//            SELECTION_PARAMETER == processLog ||
//            SELECTION_PARAMETER == processLogNumberOfTimes||
...
//    switch (SELECTION_PARAMETER) // New Changes 07082023 all comment out
//    {
//      case Stir_ON_OFF :
//        STIR_VALUE_SET  = SET_LONG_VALUE[Stir_ON_OFF];
//        break;
