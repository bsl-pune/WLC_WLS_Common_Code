...
//                 Serial2.print("TEMP_VALUE_FINAL");  Serial2.print("\t");Serial2.println(TEMP_VALUE_FINAL);
//                 Serial2.print("TEMP_VALUE_INITIAL");Serial2.print("\t");Serial2.println(TEMP_VALUE_INITIAL);
//                 Serial2.print("STOP_COUNT_VALUE");  Serial2.print("\t");Serial2.println(STOP_COUNT_VALUE);
//                 Serial2.print("START_COUNT_VALUE"); Serial2.print("\t");Serial2.println(START_COUNT_VALUE);
        ...
        case Log:                                          //Siddhesh Log
             ...
             ALL_LED_OFF();
              led.BREAK_NUMBER2(processLog*10);
                ...
                digits1[0] = 13;
             //led.DISPLAY_DIGIT2(23, 23, 23, 30) ;//A000
            // led.DISPLAY_DIGIT1(30, 23, 23, 23) ;//000H
             currentMillis=0;        
        break;
