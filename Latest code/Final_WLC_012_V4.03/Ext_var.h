...
extern float SET_TEMP_DEG, TEMP_DEG,TEMP_DEG_RAW,TEMP_DEG_RAW_1,TEMP_FAH_RAW, TEMP_FAH;
...
extern int  SET_TEMP_FAH, ERROR_CAL_IN_FAH; 
...
extern bool select_product_type; 
extern bool select_heating_type; 
extern bool checkTempRaised; 
extern float temp_pb_1;
extern float TEMP_DEG_RAW2;
